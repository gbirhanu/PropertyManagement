...
public class MachineMapsActivity extends AppCompatActivity implements GoogleMap.OnMyLocationClickListener, GoogleMap.InfoWindowAdapter, GoogleMap.OnInfoWindowClickListener, OnMapReadyCallback, NavigationView.OnNavigationItemSelectedListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent intent = new Intent(MachineMapsActivity.this, ViewAllMachinery.class);
                    intent.putExtra("userIds", mUserId);
                    startActivity(intent);
                    return true;
                case R.id.navigation_dashboard:
                    Intent intents = new Intent(MachineMapsActivity.this, SearchMachinery.class);
                    intents.putExtra("userIds", mUserId);
                    startActivity(intents);
                    return true;
                case R.id.navigation_profile:
                    Intent intentss = new Intent(MachineMapsActivity.this, ProfileActivity.class);
                ...
                case R.id.navigation_main:
                    Intent intent2 = new Intent(MachineMapsActivity.this, dashboardActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_maps);
...
//        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MachineMapsActivity.this);
...
//        alertDialog.show();
        ...
        public void onLocationResult(LocationResult locationResult) {
            for (Location location : locationResult.getLocations()) {
                if (getApplicationContext() != null) {
                    ...
                    //Toast.makeText(MachineMapsActivity.this, mLoclatitudeString, Toast.LENGTH_SHORT).show();
    ...
    private void getAllHouses() {
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                homesTypes = jo.getString(Config.TAG_MACHINE_TYPE);
                homePrices = jo.getString(Config.TAG_PRICE);
                String isWTA = jo.getString(Config.TAG_BUILT_YEAR);
                homePhotoString = jo.getString(Config.TAG_PHOTO);
                // homeLocation = jo.getString(Config.TAG_LOC);
                //Toast.makeText(this, "House is "+homesTypes+"home prices"+homePrices, Toast.LENGTH_SHORT).show();
                homesLayout = jo.getString(Config.TAG_MACHINE_MODEL);
                ...
                mMarker= mMap.addMarker(new MarkerOptions().position(latLng)
                        .title(getString(R.string.machinery_type_txt)+": "+homesTypes)
                        .snippet(getString(R.string.built_year_txt)+": "+isWTA+ "\n" + getString(R.string.machine_model)+": "+homesLayout)
     ...
     *
     * @param value
     * @return String in amharic or English String based user setting
     */
    ...
    private void getJSON(){
        ...
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MachineMapsActivity.this,null,getString(R.string.wait_text),false,false);
            }
            @Override
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                JSON_STRING = s;
               // Toast.makeText(MachineMapsActivity.this, ""+JSON_STRING, Toast.LENGTH_SHORT).show();
                getAllHouses();
                if (isaddhome!=null){
                    if (mLastLocation!=null){
                        if (uStatus.equals("1")) {
                            Intent intent = new Intent(MachineMapsActivity.this, RegisterMachinery.class);
                            ...
                            Toast.makeText(MachineMapsActivity.this, "You have no privilege to register home", Toast.LENGTH_SHORT).show();
                        }
                    }else {
                        Toast.makeText(MachineMapsActivity.this, "Enable your Location Service", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    //Toast.makeText(MachineMapsActivity.this, "Am I null "+isaddhome, Toast.LENGTH_SHORT).show();
                }
                // Toast.makeText(MachineMapsActivity.this, "house is again "+s, Toast.LENGTH_LONG).show();
            }
            @Override
        ...
        if (id == R.id.nav_registration) {
            if (mLastLocation!=null){
                if (uStatus.equals("1")) {
                    ...
                    Toast.makeText(this, "You have no privilege to register home", Toast.LENGTH_SHORT).show();
                }
            }else {
            ...
            Intent intent = new Intent(MachineMapsActivity.this,SearchMachinery.class);
            intent.putExtra("userIds",mUserId);
            startActivity(intent);
            ...
            Intent intent = new Intent(MachineMapsActivity.this, ListMyMachinery.class);
            intent.putExtra("userIds",mUserId);
            ...
            Intent intent = new Intent(MachineMapsActivity.this,ActivateMachinery.class);
            intent.putExtra("userIds",mUserId);
            intent.putExtra("houseisfor",houseisf);
            intent.putExtra("mStatus",uStatus);
            ...
            try {
                ...
                Toast.makeText(MachineMapsActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void clearUserSession(final String mUserId) {
        class AddHouse extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(MachineMapsActivity.this,"Successfully Logout",Toast.LENGTH_LONG).show();
                startActivity(new Intent(MachineMapsActivity.this,LoginActivity.class));
                finish();
            }
            @Override
        ...
        builder.setPositiveButton("Enter", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (m_Text.equals("hr123d")) {
                    Intent intent = new Intent(MachineMapsActivity.this, ServiceActivation.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(MachineMapsActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create()
                        .show();
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        try {
            ...
            Intent intent= new Intent(MachineMapsActivity.this,MachineDetails.class);
    ...
    public View getInfoWindow(Marker marker) {
        View view = LayoutInflater.from(MachineMapsActivity.this).inflate(R.layout.info_window_layout,null,false);
