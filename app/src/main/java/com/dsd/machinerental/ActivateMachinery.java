...
public class ActivateMachinery extends AppCompatActivity {
    ...
    private void getJSONDeactivated() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivateMachinery.this, null, getString(R.string.wait_text), false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Config.URL_GET_ACTIVATE_MACHINERY, mUserId);
                return s;
        ...
        try {
            ...
            if (result.length() > 0) {
                for (int i = 0; i < result.length(); i++) {
                    ...
                    MyCustomMachineAdapter adapter = new MyCustomMachineAdapter(ActivateMachinery.this, machineList, JSON_STRING, hfsor, ustat, function);
