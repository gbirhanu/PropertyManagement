...
/**
 * Created by Gemechu on 8/17/2019.
 */

public class MyHomeAdapter extends RecyclerView.Adapter<MyHomeAdapter.ProductViewHolder> {
    ...
    public MyHomeAdapter(Context mCtx, List<House> productList, String jString, String hfros, String uStatus, String function) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.myhouse_list, null);
              ...
              /*  holder.textViewUphone.setVisibility(View.VISIBLE);
                ...
                */
                ...
                try {
                    ...
                    Intent intent =new Intent(mCtx,UpdateHome.class);
                    intent.putExtra("JsonObject",jo.toString());
                    intent.putExtra("houseisfor",hfros);
